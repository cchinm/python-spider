...
if __name__ == "__main__":
    import sys
    hashstr = 'http://finance.sina.com.cn/roll/2017-05-11/doc-ifyfecvz0892287.shtml'
    #hashstr = '反对'

    #hash, hash2 = hashlittle2(hashstr, 0xdeadbeef, 0xdeadbeef)
    #print '"%s": %x %x' % (hashstr, hash, hash2)

    hash = hashlittle2(hashstr, 0)
    print(hashstr, hash)
    hashstr = 'http://finance.sina.com.cn/roll/2017-05-11/doc-ifyfecvz08922870.shtml'
    # hashstr = '反对'
